...
import { hasTwoDigitsWithSum, hasTwoDigitsWithSumV2, hasTwoDigitsWithSumV3 } from './number-09';
...
describe('hasTwoDigitsWithSumV2', () => {
  ...
  it('should return false when sum of two digits not equal initial number ', () => {
    ...
    expect(hasTwoDigitsWithSumV2(101, 5)).toBe(false);
    expect(hasTwoDigitsWithSumV2(59302, 10)).toBe(false);
    expect(hasTwoDigitsWithSumV2(12345, 2)).toBe(false);
  });
  it('should return true when sum of two digits equal initial number', () => {
    expect(hasTwoDigitsWithSumV2(101, 2)).toBe(true);
    expect(hasTwoDigitsWithSumV2(123, 5)).toBe(true);
    expect(hasTwoDigitsWithSumV2(56302, 8)).toBe(true);
    expect(hasTwoDigitsWithSumV2(111, 2)).toBe(true);
  });
});

describe('hasTwoDigitsWithSumV3', () => {
  it('should return false when n<=9 || n>=1000000 || sum<=0 || sum >=19', () => {
    Array.from({ length: 10 }, (n, i) => i).forEach((x) => {
      expect(hasTwoDigitsWithSumV3(x, 1)).toBe(false);
      expect(hasTwoDigitsWithSumV3(x, 0)).toBe(false);
      expect(hasTwoDigitsWithSumV3(x, 19)).toBe(false);
    });
  });
  it('should return false when sum of two digits not equal initial number ', () => {
    expect(hasTwoDigitsWithSumV3(101, 3)).toBe(false);
    expect(hasTwoDigitsWithSumV3(101, 5)).toBe(false);
    expect(hasTwoDigitsWithSumV3(59302, 10)).toBe(false);
    expect(hasTwoDigitsWithSumV3(12345, 2)).toBe(false);
  });
  it('should return true when sum of two digits equal initial number', () => {
    expect(hasTwoDigitsWithSumV3(101, 2)).toBe(true);
    expect(hasTwoDigitsWithSumV3(123, 5)).toBe(true);
    expect(hasTwoDigitsWithSumV3(56320, 5)).toBe(true);
    expect(hasTwoDigitsWithSumV3(111, 2)).toBe(true);
  });
});
